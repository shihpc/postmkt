...
# （2026-09-10 覆驗算出，本批原本沒寫）。依四天**實際起跑時刻**換算新規則會給多少期限：
#   09-07 → 109 分／09-08 → 105 分／09-09 → **100 分**／09-10 → 109 分。
# 而那包唯一成功的 batch 跑了 **104 分**。**若 09-10 照 09-09 的時刻（台北 21:20）起跑，
# 新規則一樣會把它 cancel 掉。** 所以「牌鐘救得到 104 分那包」只在起跑夠早的日子成立，
# 餘裕是 1~5 分鐘等級，**不是結構性的保證**。起跑時刻由 v2 Worker 的晚場協調班決定
...
# **牌鐘生效的那天，彙總必然失去半價**：摘要被砍時已過 23:00 → 彙總這次算出的期限必為 0 →
