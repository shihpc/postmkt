...
「唯一放寬處是……單一字母後綴（特別股／**存託憑證**，例如 `2887Y`）」——`2887Y` 是**特別股不是
存託憑證**（且實查 `TaiwanStockInfo` 3,147 檔裡沒有 `2887Y`，現存的是 `2887F`／`2887Z1`），
...
> `2887Y`）」有兩個錯：①`2887Y` 是**特別股不是存託憑證**（且 2026-09-09 實查 `TaiwanStockInfo`
> 3,147 檔裡**根本沒有 `2887Y`**，同一檔金控現存的是 `2887F`／`2887Z1`）；②真正的存託憑證是
